...
var EXAMPLE = {
  ...
  Drills: [
    ...
    ['Net Games', 'Attacking shot', 1, 'Stage 1 · the shot', '4 of 5 hit down, over and in (see the back)'],
    ['Net Games', 'Attacking shot', 2, 'Stage 2 · to a called zone', '3 of 5 (see the back)'],
    ['Net Games', 'Attacking shot', 3, 'Stage 3 · on the move (the test)', '3 of 5 (see the back)'],
  ...
  BackPage: [
    ...
    ['Net Games', 'Two cone zones, LEFT and RIGHT, at the back of the opponent\'s court, and a centre cone on your side. Stage 3 is the test. Recovery is a rule, not a score: the feeder waits until you touch the centre cone before the next feed, so your partner only counts whether the shot landed in the zone.'],
    ['Net Games', '| Stage | Volleyball | Move on when… | Badminton | Move on when… |'],
    ['Net Games', '| 1 · the shot | Toss to the same spot. Approach (step-close), jump and arm swing; spike down over the net, anywhere in. Beginners: standing overhead attack. | 4/5 hit down, over and in | High lift to the same spot. Overhead smash shape: side-on, elbow high, contact in front; hit down over the net, anywhere in. | 4/5 hit down, over and in |'],
    ['Net Games', '| 2 · to a target | Same toss. Partner calls LEFT or RIGHT before each toss; spike into the called zone. | 3/5 in the called zone | Same lift. Partner calls LEFT or RIGHT before each lift; smash into the called zone. | 3/5 in the called zone |'],
    ['Net Games', '| 3 · on the move (the test) | Start at the centre cone. Tosses to alternating sides, zone called each time. Touch the cone before the next toss. | 3/5 in the called zone | Start at the centre cone. Lifts to alternating sides, zone called each time. Touch the cone before the next lift. | 3/5 in the called zone |'],
